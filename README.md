<!-- 
=======================================================================
  Mertcan Kaya - GitHub Profile README
  To use this, save it as README.md in a repository named 'mertcan-kaya'
=======================================================================
-->

# Hi there, I'm Mertcan Kaya! 👋

<!-- INTRODUCTION: A brief, engaging hook summarizing your professional identity -->
...
## 🚀 About Me
<!-- ABOUT ME: Key highlights of your skills, current focus, and personality -->
...
<!-- PROJECTS: Showcase your best open-source or academic work -->
- [Robot Simulation MATLAB GUI](https://github.com/mertcan-kaya/robot-simulation-matlab-gui) - Real-time 3D kinematic trajectory updates via MATLAB App Designer.
- [Adaptive Newton-Euler Algorithm](https://github.com/mertcan-kaya/adaptive-newton-euler-algorithm-simulation) - Computational simulation for adaptive robot controllers based on our published article.
- [Probabilistic Mobile Robot Simulation](https://github.com/mertcan-kaya/probabilistic-mobile-robot-simulation) - Algorithms for mobile robot localization, mapping, and planning.

## 📫 Get in Touch
<!-- CONTACT: Keep your professional links up to date -->
- **Email:** mertcan.kaya@hs-coburg.de | mertcan.kaya@gmail.com | mertcan.kaya@tum.de
- **Personal Website:** [mertcan-kaya.github.io](https://mertcan-kaya.github.io/index.html)
- **ORCID:** [0000-0002-3174-9394](https://orcid.org/0000-0002-3174-9394)
- **Scopus ID:** [57198376675](https://www.scopus.com/authid/detail.uri?authorId=57198376675)
...
<!-- EXPERIENCE: Reverse chronological order of your professional roles -->
**Dec 2025 – Present**  
...
## 🎓 Education
<!-- EDUCATION: Reverse chronological order of your academic history -->
**Apr 2023 – Present**  
...
<!-- PUBLICATIONS: Categorized to highlight your academic track record -->
### Journal Articles
- **Kaya, M.**, Becker, K., Greve, J., Keller, J., Meserle, M., Först, C., Siegel, R., Stelzer, J., & Kühnlenz, K. (2026). Motor interference of elbow configuration changes in human-robot interaction. *Interaction Studies*, 26(1), 130-149. [doi:10.1075/is.25026.kay](https://doi.org/10.1075/is.25026.kay)
- **Kaya, M.**, & Kühnlenz, K. (2025). Subjective task-load influences anthropomorphism during cooperative human and robot hand movements. *Automatisierungstechnik*, 73(1), 22-28. [doi:10.1515/auto-2024-0031](https://doi.org/10.1515/auto-2024-0031)
...
*(For a full list of publications and conference proceedings, please visit my [Google Scholar](https://scholar.google.com/citations?user=cU3jkSAAAAAJ) or [Personal Website](https://mertcan-kaya.github.io/index.html).)*
...
<!-- SKILLS: Grouped for easy scanning -->
...
<!-- FOOTER: Automatically update the date below when making changes -->
